...
pub async fn get_first_thread_msg_content(oac: &async_openai::Client<async_openai::config::OpenAIConfig>, thread_id: &ThreadId) -> std::prelude::v1::Result<String, Box<dyn Error>> {
